...
class LaneBorder:
    ...
    @staticmethod
    def from_xml(elem: etree._Element) -> LaneBorder:
        """Creates a LaneBorder instance from an XML node."""
        ...
        return LaneBorder(a=a, b=b, c=c, d=d, s_offset=s_offset)

    def to_xml(self) -> etree._Element:
        """Creates an XML element from the LaneBorder instance."""
        elem = etree.Element("border")
